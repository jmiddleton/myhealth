...
import info.puntanegra.fhir.server.web.filter.CachingHttpHeadersFilter;
import info.puntanegra.fhir.server.web.filter.StaticResourcesProductionFilter;
import info.puntanegra.fhir.server.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		initializeCORSFilter(servletContext, disps);
	...
	private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
		...
		WebFilter webFilter = new WebFilter() {
			...
			protected HazelcastInstance getInstance(Properties properties) throws ServletException {
				return null;//CacheConfiguration.getHazelcastInstance();
			}
		};
	...
	private void initializeCORSFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
