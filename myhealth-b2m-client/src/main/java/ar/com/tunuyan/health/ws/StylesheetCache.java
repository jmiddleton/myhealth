...
public class StylesheetCache {
	 ...
	 * @throws IOException
	 */
	public static synchronized Transformer newTransformer(Resource xsltFile) throws TransformerConfigurationException,
			IOException {
		String xsltFileName = xsltFile.getFilename();
		...
		if (entry == null) {
			Source xslSource = new StreamSource(xsltFile.getInputStream());
